 ...
 * @project koali
 * @package com.clover.koali.wechat.miniapp.bean
 * @file WechatMiniTemplateMessage.java
...
@AllArgsConstructor
@Builder
public class WechatMiniTemplateMessage implements Serializable {
    ...
    public WechatMiniTemplateData addData(WechatMiniTemplateData datum) {
        if (this.data == null) {
